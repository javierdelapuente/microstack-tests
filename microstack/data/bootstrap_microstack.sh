...
export LOCAL_IPADDR=$(ip -4 -j route get 2.2.2.2 | jq -r '.[] | .prefsrc') && echo $LOCAL_IPADDR

cat ~/base-microstack-manifest | envsubst '$EXTERNAL_IFNAME,$LOCAL_IPADDR' > ~/base-microstack-manifest.temp1
